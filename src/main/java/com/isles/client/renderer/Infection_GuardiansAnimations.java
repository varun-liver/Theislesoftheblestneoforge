...
public class Infection_GuardiansAnimations {
	...
	public static final AnimationDefinition punch = AnimationDefinition.Builder.withLength(1.25F)
		...
		.addAnimation("arm1", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -11.0F), AnimationChannel.Interpolations.LINEAR),
