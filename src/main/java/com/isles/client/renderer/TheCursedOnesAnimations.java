 ...
 * @author Author
 */
public class TheCursedOnesAnimations {
	...
	public static final AnimationDefinition punch = AnimationDefinition.Builder.withLength(2.0F)
		...
		.addAnimation("arm1", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.75F, KeyframeAnimations.posVec(0.0F, 0.0F, 10.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.25F, KeyframeAnimations.posVec(0.0F, 0.0F, -19.0F), AnimationChannel.Interpolations.LINEAR),
