 ...
 * @author Author
 */
public class TheinfectionAnimations {
	...
	public static final AnimationDefinition smash = AnimationDefinition.Builder.withLength(3.0F)
		...
		.addAnimation("arm2", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, -22.0F, 22.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, -22.0F, 22.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("arm1", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.25F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, -22.0F, 27.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(2.0F, KeyframeAnimations.posVec(0.0F, -22.0F, 27.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(3.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.build();
	...
	public static final AnimationDefinition summon = AnimationDefinition.Builder.withLength(1.25F)
		.addAnimation("arm2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(-22.5F, 0.0F, -170.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(-22.5F, 0.0F, -170.0F), AnimationChannel.Interpolations.LINEAR),
		...
		.addAnimation("armt7", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(-60.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(-60.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
	...
	public static final AnimationDefinition blast = AnimationDefinition.Builder.withLength(1.75F)
		...
		.addAnimation("armt7", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(1.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 1800.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("arm11", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
