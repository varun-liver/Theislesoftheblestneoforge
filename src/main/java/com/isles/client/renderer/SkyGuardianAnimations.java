...
public class SkyGuardianAnimations {
    public static final AnimationDefinition ATTACK = AnimationDefinition.Builder.withLength(0.5F)
            .addAnimation("larm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.25F, KeyframeAnimations.degreeVec(-45.0F, 0.0F, 15.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .build();

    public static final AnimationDefinition ATTACK_2 = AnimationDefinition.Builder.withLength(2.25F)
            .addAnimation("rarm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.75F, KeyframeAnimations.degreeVec(-102.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
