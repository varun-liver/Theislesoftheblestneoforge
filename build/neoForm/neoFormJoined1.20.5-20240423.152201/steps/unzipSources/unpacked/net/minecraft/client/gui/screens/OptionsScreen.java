...
public class OptionsScreen extends Screen {
    ...
    protected void init() {
        ...
        this.layout.addToFooter(Button.builder(CommonComponents.GUI_DONE, p_315820_ -> this.onClose()).width(200).build());
    ...
    public static CycleButton<Difficulty> createDifficultyButton(int p_262051_, int p_261805_, String p_261598_, Minecraft p_261922_) {
        return CycleButton.builder(Difficulty::getDisplayName)
            ...
            .create(
                ...
                (p_293599_, p_293600_) -> p_261922_.getConnection().send(new ServerboundChangeDifficultyPacket(p_293600_))
            );
    }
