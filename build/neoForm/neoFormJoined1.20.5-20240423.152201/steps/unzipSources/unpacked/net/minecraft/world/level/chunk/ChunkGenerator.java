...
public abstract class ChunkGenerator {
    ...
    public CompletableFuture<ChunkAccess> createBiomes(
        Executor p_223159_, RandomState p_223160_, Blender p_223161_, StructureManager p_223162_, ChunkAccess p_223163_
    ) {
                        ...
                        for (Structure structure : map.getOrDefault(k, Collections.emptyList())) {
                            ...
                            try {
                                ...
                                p_223089_.startsForStructure(sectionpos, structure)
                                    .forEach(
                                        p_223086_ -> p_223086_.placeInChunk(p_223087_, p_223089_, this, worldgenrandom, getWritableArea(p_223088_), chunkpos)
                                    );
    ...
    public abstract CompletableFuture<ChunkAccess> fillFromNoise(
        Executor p_223209_, Blender p_223210_, RandomState p_223211_, StructureManager p_223212_, ChunkAccess p_223213_
    );
